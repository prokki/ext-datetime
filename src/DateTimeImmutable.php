...
class DateTimeImmutable extends \DateTimeImmutable
{
    ...
    /**
     * Overrides {@see \DateTime::createFromMutable()} to return a {@see \ExtDateTime\DateTimeImmutable} object
     * instead of the default {@see \DateTimeImmutable} object.
     *
     * @param \DateTime $DateTimeMutable
     *
     * @return boolean|static
     *
     * @throws Exception
     */
    public static function createFromMutable($DateTimeMutable)
    {
        return static::createFromObject($DateTimeMutable);
    }

    /**
     * Copies and casts the submitted datetime object to a new {@see \ExtDateTime\DateTimeImmutable} object.
     *
    ...
    /**
     * Static constructor. Returns a new {@see \ExtDateTime\DateTimeImmutable} object.
     *
     * @param string       $time
    ...
    /**
     * Converts the immutable datetime object to a mutable datetime object.
     *
     * Wrapper function of {\ExtDateTime\DateTime::createFromImmutable()}.
     *
     * @return DateTime
     *
     * @throws Exception
    ...
    public function addMonth(int $month): DateTimeInterface
    {
        ...
        $dateTimeImmutable = $this->add(DateInterval::createFromDateString(sprintf('%d month', $month)));

        if( $absoluteMonths + $month !== $dateTimeImmutable->getAbsoluteMonths() )
        {
            $dateTimeImmutable = $dateTimeImmutable->subDays((int) $dateTimeImmutable->format('d'));
        }
    ...
    public function subMonth(int $month): DateTimeInterface
    {
        ...
        $dateTimeImmutable = $this->sub(DateInterval::createFromDateString(sprintf('%d month', $month)));
